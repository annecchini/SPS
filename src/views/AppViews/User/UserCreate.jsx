...
class UserCreate extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if (
      this.state.createProcess_numberError !== null ||
      this.state.createProcess_yearError !== null ||
      this.state.createProcess_endError !== null ||
      (this.state.createProcess_number === "" ||
        this.state.createProcess_year === "" ||
        this.state.createProcess_end === "")
    ) {
      readyToPost = false;
      this.setState({
        createProcess_formError: (
