                                    ...
                                    <Form horizontal>
                                        ...
                                        <div className="col-md-offset-3">
                                            ...
                                            <dl className="dl-horizontal">
                                                ...
                                                <dt>Processo:</dt>
                                                <dd>{`${FormatHelpers.processNumber(this.props.process.number)}/${this.props.process.year}`}</dd>
                                                <dt>Data de criação:</dt>
                                                <dd>{moment(this.props.process.createdAt).format('DD/MM/YYYY')}</dd>
                                        ...
                                        <FormGroup>
                                            <Col md={8} mdOffset={3}>
                                                <Button bsStyle="danger" fill onClick={event => this.handleSubmit(event)}>
                                                    Excluir processo
                                                    </Button >
                                                {" "}
